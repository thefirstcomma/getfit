...
<div class="card" style="width: 18rem; display: inline-block;">
	...
	<div class="card-body">
		...
		<a href="#" class="btn btn-primary btn-view-save" data-toggle="modal" data-target=".modal" data-id="<?= $save->id ?>" data-title="<?= $save->title ?>" data-height="<?= $save->height ?>" data-chest="<?= $save->chest ?>" data-waist="<?= $save->waist ?>" data-hips="<?= $save->hips ?>" data-inseam="<?= $save->seam ?>" data-size="<?= $save->dress_size ?>" data-dress="<?= $save->dress_id ?>">View</a>
