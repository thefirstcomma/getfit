...
<div class="row">
	...
	<div class="card" style="width: 250px; height: auto;">
		<img class="a" src="<?= wp_upload_dir()['baseurl'] . $dress->dress_location ?>" alt="<?= $dress->name ?>" height="200" width="200">
		<div class="card-body">
			<h5 class="card-title">Name: <?= $dress->name ?></h5>
			<p class="card-text">Description: <?= $dress->description ?></p>
			<p>Price: $1M</p>
		</div>
